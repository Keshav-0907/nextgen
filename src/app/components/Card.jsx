    ...
    return (
        <div>
            ...
            <div class="flex flex-col justify-center items-center">
                <div class="!z-5 relative flex flex-col rounded-[20px] max-w-[300px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 flex flex-col w-full !p-4 3xl:p-![18px]  undefined">
                    <div class="h-fit w-fit bg-gray-200 p-2 rounded-[20px]">
                        ...
                        <div class="mb-3 flex items-center justify-between px-1 md:items-start">
                            <div class="mb-2">
                                <p class="text-lg font-bold text-navy-700"> Mr. ABC </p>
                                <p class="mt-1 text-sm font-medium text-gray-600 md:mt-2"> SDE at somewhere </p>
                            </div>

                        </div>
                        <div class="flex items-center justify-around md:items-center lg:justify-around ">
